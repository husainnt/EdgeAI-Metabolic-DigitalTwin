...
def build_report():
    ...
    for i, pid in enumerate(sorted(oral_med_ids)):
        ...
        spo2_present, spo2_count = check_modality(SPO2_DIR, pid, "oxygen_saturation")
        activity_present, activity_count = check_modality(ACTIVITY_DIR, pid, "physical_activity", ["steps"])
